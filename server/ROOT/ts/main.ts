...
{
	id:any3; title; partial; children; parentStart;
}
...
function loadText(mode, px=null)
{
	var m = loadMode;
...
function scrollTextBy(ofs:number)
{
	scrollTop += ofs;
...
function Book()
{
	...
	function init(json, force):boolean
	{
...
$(function()
{
	...
	$(window).on('mousewheel', function(e:JqMouseWheelEvent)
	{
		if(e.deltaY > 0)
			up(measure.lnHgt());
		else if(e.deltaY < 0)
